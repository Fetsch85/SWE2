...
//						clientModel.möglicheFelderAnzeigen(spielbrett.getAktiverTurmKoordinaten());
						...
						clientModel.setTurmKoordinaten(t.getKoordinaten());
						logger.info("Turmkoordinaten gesetzt " + t.getKoordinaten()[0] + " " + t.getKoordinaten()[1]);
						clientModel.TurmSenden();
						logger.info("Turmkoordinaten gesendet");
					}
			...
			for (int j = 0; j < spielbrett.getFelder().length; j++){
				...
				ausgewähltesFeld.setOnMouseClicked(new EventHandler<MouseEvent>(){
					...
					public void handle(MouseEvent event){
						...
						int[] koordinatenAusgewähltesFeld = ausgewähltesFeld.getKoordinaten();
						clientModel.setAusgewähltesFeldKoordinaaten(koordinatenAusgewähltesFeld);	
						logger.info("Feldkoordinaten gesetzt");
						
						clientModel.KoordinatenSenden();
						logger.info("Koordinaten gesendet");
...
//				AnmeldefensterView anmeldeView = new AnmeldefensterView(stage,)
	...
	public void zugMachen(Feld ausgewähltesFeld){
